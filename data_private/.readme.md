...
# readme.md that you will actually follow

when user demands new conversation, answer with a summary of conversation and ask if it should be part of next conversation run: ./.scripts/new_conversation_history.sh "bullet points as parameter"
-> what you do: show relevant stuff, you work on text till user is satisfied, then you run script with parameter
