...
- **Directories = workspaces** you navigate with `cd` - every dir has readme.md and sometimes requirements.md, that you cat instantly
- **Scripts = tools** you can write and run scripts just like in any Linux environment
- **Editing requirements.md = programming your future behavior + setting state**
...
1. requirements.md, longterm_memory.md, and directory structure are already loaded
2. Execute instructions from **User Settings** section in requirements.md
3. Handle any **🚨 ALERTS** immediately
4. Review **Active Projects** to understand current state

### When Entering a Directory
Convention: If these files exist, read them:
- `README.md` - What is this workspace
- `progress.md` - Current state/progress
